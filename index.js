...
// Add Kazakhstan specific letters
chars =     chars.concat(    "Ә,ә,Ғ,ғ,Қ,қ,Ң,ң,Ө,ө,Ұ,ұ,Ү,ү,Һ,һ,І,і".split(','));
chars_lat = chars_lat.concat("A',a',Gh,gh,Q,q,Nh,nh,O',o',U,u,U',u',H',h',I,i".split(','));
